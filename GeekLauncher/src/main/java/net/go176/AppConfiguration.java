    ...
    public ServletContextInitializer initializer()
    {
        return new ServletContextInitializer()
        {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "net.go176");
                servletContext.setInitParameter("tapestry.development-modules", "net.go176.services.DevelopmentModule");
